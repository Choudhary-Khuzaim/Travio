...
final List<Destination> destinationsList = [
  ...
  Destination(
    ...
    hotels: [
      ...
      {
        'name': 'Emaraat Hotel',
        'image': 'assets/images/emaraat_hotel.png',
        'rating': 4.5,
        'price': 'Rs. 20,000',
      ...
      {
        'name': 'Greens Hotel',
        'image': 'assets/images/greens_hotel.png',
        'rating': 4.1,
        'price': 'Rs. 10,000',
        'location': 'Saddar, Peshawar',
      },
  ...
  Destination(
    ...
    hotels: [
      ...
      {
        'name': 'Vista Hotel',
        'image': 'assets/images/vista_hotel_hyderabad.png',
        'rating': 4.0,
        'price': 'Rs. 9,000',
  ...
  Destination(
    ...
    hotels: [
      ...
      },
      {
        ...
        'image': 'assets/images/hotel_one_multan.png',
        'rating': 4.4,
        'price': 'Rs. 16,000',
        'location': 'Lalik Chowk, Multan',
      },
      {
        'name': 'Sazal Hotel',
        'image': 'assets/images/sazal_hotel.png',
        'rating': 4.1,
        'price': 'Rs. 11,000',
        'location': 'Abdali Rd, Multan',
      },
  ...
  Destination(
    ...
    hotels: [
      ...
      },
      {
        ...
        'image': 'assets/images/grand_regent_faisalabad.png',
        'rating': 4.5,
        'price': 'Rs. 20,000',
        'location': 'Mall Rd, Faisalabad',
      },
      {
        'name': 'Raj One Hotel',
        'image': 'assets/images/raj_one_hotel.png',
        'rating': 4.0,
        'price': 'Rs. 10,000',
  ...
  Destination(
    ...
    hotels: [
      ...
      {
        'name': 'Burj Al Swat',
        'image': 'assets/images/burj_al_swat.png',
        'rating': 4.6,
        'price': 'Rs. 22,000',
        'location': 'Fizagat, Swat',
      },
      {
        'name': 'Hotel One Swat',
        'image': 'assets/images/hotel_one_swat.png',
        'rating': 4.3,
        'price': 'Rs. 15,000',
  ...
  Destination(
    ...
    hotels: [
      ...
      },
      {
        ...
        'image': 'assets/images/eagles_nest_hunza.png',
        'rating': 4.8,
        'price': 'Rs. 30,000',
        'location': 'Duikar, Hunza',
      },
      {
        'name': 'Hard Rock Hunza',
        'image': 'assets/images/hard_rock_hunza.png',
        'rating': 4.5,
        'price': 'Rs. 22,000',
        'location': 'Eagle\'s Nest Rd, Hunza',
      },
    ],
    latitude: 36.3167,
    longitude: 74.6500,
  ...
  Destination(
    ...
    hotels: [
      ...
      },
      {
        ...
        'image': 'assets/images/hotel_one_skardu.png',
        'rating': 4.4,
        'price': 'Rs. 18,000',
      ...
      },
      {
        ...
        'image': 'assets/images/mashabrum_hotel.png',
        'rating': 4.2,
        'price': 'Rs. 14,000',
        'location': 'College Rd, Skardu',
      },
    ],
    latitude: 35.2971,
    longitude: 75.6333,
  ...
  Destination(
    ...
    hotels: [
      ...
      {
        'name': 'Sadaf Resort',
        'image': 'assets/images/sadaf_resort_gwadar.png',
        'rating': 4.3,
        'price': 'Rs. 15,000',
        'location': 'Marine Drive, Gwadar',
      },
      {
        'name': 'Gwadar Palace Hotel',
        'image': 'assets/images/gwadar_palace.png',
        'rating': 4.5,
        'price': 'Rs. 20,000',
        'location': 'Jinnah Avenue, Gwadar',
      },
    ],
    latitude: 25.1216,
    longitude: 62.3254,
  ...
  Destination(
    ...
    hotels: [
      ...
      {
        'name': 'Juniper Lodge',
        'image': 'assets/images/juniper_lodge.png',
        'rating': 4.5,
        'price': 'Rs. 18,000',
        'location': 'Ziarat Valley',
      },
      {
        'name': 'Green Top Hotel',
        'image': 'assets/images/green_top_hotel.png',
        'rating': 4.1,
        'price': 'Rs. 10,000',
        'location': 'Ziarat',
      },
