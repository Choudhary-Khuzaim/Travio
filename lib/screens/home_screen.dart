...
import 'package:travio/core/custom_shapes.dart';
...
class _HomeScreenState extends State<HomeScreen> {
          ...
          _build3DCarousel(),
           ...
           Padding(
            ...
            child: _buildSectionHeader(
              "Explore",
              "View All",
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ExploreScreen())), // Navigate to Search or Explore
            ),
          ),
  ...
  Widget _buildCategoryPills() {
    final categories = [
      ...
      {'icon': Icons.hotel, 'label': 'Hotels', 'route': const HotelBookingScreen()},
      {'icon': Icons.directions_car, 'label': 'Cabs', 'route': const CabBookingScreen()},
      ...
      child: Row(
        children: categories.asMap().entries.map((entry) {
          ...
          return GestureDetector(
            onTap: () {
              if (cat['route'] != null) {
                Navigator.push(context, MaterialPageRoute(builder: (_) => cat['route'] as Widget));
              }
            },
            child: Container(
              ...
              Positioned(
                ...
                child: Container(
                   ...
                   child: Row(
                     ...
                     children: [
                       const Icon(Icons.star, color: Colors.orange, size: 16), // Orange star
                       const SizedBox(width: 4),
                       Text(
                         dest.rating.toString(),
                         style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 13), // Black text
                       ),
                     ],
                   ),
                ),
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    padding: const EdgeInsets.all(8),
                     ...
                     child: Icon(
                       _likedDestinations.contains(dest.id) ? Icons.favorite : Icons.favorite_border,
                       color: _likedDestinations.contains(dest.id) ? Colors.red : Colors.grey, // Red or Grey
                       size: 20,
                     ),
                  ),
                ),
