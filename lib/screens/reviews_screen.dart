...
class _ReviewsScreenState extends State<ReviewsScreen> {
    ...
    setState(() {
      ...
      switch (index) {
        ...
        case 2: // Positive (Rating >= 4.5)
          _filteredReviews = mockReviews.where((r) => (r['rating'] as double) >= 4.5).toList();
          break;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ).animate().slideY(begin: 0.1, end: 0, duration: 500.ms, curve: Curves.easeOutQuart),
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildBuilderDelegate(
                (context, index) {
                  return ReviewItem(review: _filteredReviews[index], index: index);
                },
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setModalState) => Container(
          ...
          child: Column(
            ...
            children: [
              const Center(
                child: Text("Write a Review", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              ),
              const SizedBox(height: 24),
              const Text("Rate your experience", style: TextStyle(fontWeight: FontWeight.w600, color: AppColors.textSecondary)),
              ...
              const SizedBox(height: 24),
              const Text("Share your thoughts", style: TextStyle(fontWeight: FontWeight.w600, color: AppColors.textSecondary)),
              const SizedBox(height: 12),
              TextField(
  ...
  // Helper method for Reply button
          ...
          Row(
            children: [
              _buildInteractionButton(
                ...
                label: "Helpful (${isLiked ? helpfulCount + 1 : helpfulCount})",
      ...
      child: Row(
        children: [
          ...
          Text(
            label,
            style: TextStyle(
              color: color == AppColors.primary ? AppColors.primary : Colors.grey[600],
              fontSize: 13,
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                 Navigator.pop(context);
                 ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Review reported")));
              },
            ),
            ListTile(
...
final List<Map<String, dynamic>> mockReviews = [
  {
    ...
    'date': '2 days ago',
    'rating': 5.0,
    'comment': 'Absolutely stunning experience! ✨ The view was breathtaking and the service was top-notch. Highly recommended for families looking for a peaceful getaway.',
  },
  {
    'name': 'Michael Chen',
    ...
    'date': '1 week ago',
    'rating': 4.5,
    'comment': 'Great trip overall. The hiking trails were well maintained. Food was delicious but a bit spicy for my taste. The local guide was very knowledgeable!',
  },
  {
    'name': 'Emma Davis',
    ...
    'date': '2 weeks ago',
    'rating': 5.0,
    'comment': 'A magical place! The bonfire night was the highlight of our trip. Will definitely come back next year with more friends.',
  },
   {
    'name': 'James Wilson',
    ...
    'date': '3 weeks ago',
    'rating': 4.0,
    'comment': 'Good value for money. The hotel was clean and comfortable. Transport was a bit delayed though, but the scenery made up for it.',
  },
];
