...
import 'package:travio/screens/booking/boarding_pass_ticket_screen.dart';
import 'package:travio/screens/profile/help_support_screen.dart';
            ...
            _buildActionButton(
              ...
              () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => BoardingPassTicketScreen(trip: trip),
                  ),
                );
              },
            ),
  ...
  void _showCancelDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          "Are you sure you want to cancel this booking? This action might incur cancellation charges.",
        ),
        actions: [
          TextButton(
          ...
          TextButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text("Trip cancellation submitted for processing."),
                ),
              );
            },
            child: const Text(
